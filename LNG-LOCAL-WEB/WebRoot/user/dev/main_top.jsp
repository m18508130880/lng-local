...
<body>
	<div class="top">
		...
		<div class="bar">
			...
			<div id="banner_r">
				<ul>
					<li style="display:<Limit:limitValidate userrole='<%=FpList%>' fpid='1001' ctype='1'/>">
						<img onClick="doDev01()" style="cursor:hand" src="../../skin/images/top_menu_dev_01.gif" alt="设备明细"/>
					</li>
					<li style="display:<Limit:limitValidate userrole='<%=FpList%>' fpid='1002' ctype='1'/>">
						<img onClick="doDev02()" style="cursor:hand" src="../../skin/images/top_menu_dev_02.gif" alt="持证提示"/>
					</li>
				</ul>
			</div>
		</div>
...
function doDev01()
{
	window.parent.frames.mFrame.location = "Dev_List.do?Cmd=0&Sid=<%=Sid%>&Cpm_Id="+window.parent.frames.lFrame.document.getElementById('id').value+"&Func_Corp_Id=9999&Func_Sel_Id=9";
}

function doDev02()
{
	window.parent.frames.mFrame.location = "Dev_Remind.do?Cmd=0&Sid=<%=Sid%>&Cpm_Id="+window.parent.frames.lFrame.document.getElementById('id').value+"&Func_Corp_Id=9999&Func_Sel_Id=0";
}
</SCRIPT>
</html>