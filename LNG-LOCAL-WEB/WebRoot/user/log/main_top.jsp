...
<body>
	<div class="top">
		...
		<div class="bar">
			...
			<div id="banner_r">
				<ul>
					<li style="display:<Limit:limitValidate userrole='<%=FpList%>' fpid='0501' ctype='1'/>">
						<img onClick="doAlert()" style="cursor:hand" src="../../skin/images/top_menu_alert_logs.gif" alt="告警日志"/>
					</li>	
					<li style="display:<Limit:limitValidate userrole='<%=FpList%>' fpid='0502' ctype='1'/>">
						<img onClick="doAlarm()" style="cursor:hand" src="../../skin/images/top_menu_agent_logs.gif" alt="联动日志"/>
					</li>
				</ul>
			</div>
		</div>
...
function doAlert()
{
	window.parent.frames.mFrame.location = "Alert_Info.do?Cmd=0&Sid=<%=Sid%>&Id="+window.parent.frames.lFrame.document.getElementById('id').value+"&Level="+window.parent.frames.lFrame.document.getElementById('level').value+"&Func_Sub_Id=9&Func_Sel_Id=0";
}

function doAlarm()
{
	window.parent.frames.mFrame.location = "Alarm_Info.do?Cmd=0&Sid=<%=Sid%>&Id="+window.parent.frames.lFrame.document.getElementById('id').value+"&Level="+window.parent.frames.lFrame.document.getElementById('level').value+"&Func_Sub_Id=9";
}
</SCRIPT>
</html>