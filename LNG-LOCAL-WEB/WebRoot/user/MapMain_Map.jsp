	      		...
	      		for(var i=0; i<list.length && list[i].length>0; i++)
	      		{
	      			switch(parseInt(list[i]))
	      			{
	      				...
	      				case 0102:
	      						...
	      						objHTML +=     (i+1) + '、[安全生产]-[全部隐患]有未处理记录!' + "&nbsp;&nbsp;<img src='../skin/images/redo.png' style='cursor:hand;' onclick='doSATY()' title='进入[安全生产]'>";
	      						objHTML += "  </td>";
	      						objHTML += "</tr>";
	      					break;
	      				case 0103:
	      				...
	      				case 0105:
	      						objHTML += "<tr height='25px'>";
	      						objHTML += "  <td width=100% align=left>";
	      						objHTML +=     (i+1) + '、[安全生产]-[应急演练]有未处理记录!' + "&nbsp;&nbsp;<img src='../skin/images/redo.png' style='cursor:hand;' onclick='doSATJ()' title='进入[安全生产]'>";
	      						objHTML += "  </td>";
	      						objHTML += "</tr>";
	      					break;
	      				case 0201:
...
function doSATY()
{
	...
	parent.location = 'sat/Main.jsp?Sid=<%=Sid%>&p3=1';**/
	window.parent.frames.mFrame.location = "Sat_To_Danger.do?Cmd=0&Sid=<%=Sid%>&Cpm_Id=0100000001&Func_Sub_Id=9&Func_Corp_Id=9999&Func_Sel_Id=9";
}
function doSATJ()
{
	/**if('<Limit:limitValidate userrole='<%=FpList%>' fpid='07' ctype='1'/>' == 'none')
...
window.parent.frames.mFrame.location = "Sat_To_Drill.do?Cmd=0&Sid=<%=Sid%>&Cpm_Id=0100000001&Func_Sub_Id=9&Func_Corp_Id=9999&Func_Sel_Id=9";
}
...
window.parent.frames.mFrame.location = "Cad_Remind.do?Cmd=0&Sid=<%=Sid%>&UId=<%=SYS_List%>&Func_Sub_Id=0&Func_Corp_Id=9999&Func_Sel_Id=9";
...
function doLAB()
{
	...
	parent.location = 'lab/Main.jsp?Sid=<%=Sid%>&p3=1';**/
...
function doSPA()
{
	...
	parent.location = 'spa/Main.jsp?Sid=<%=Sid%>&p3=1';**/
...
function doFIX()
{
	...
	parent.location = 'fix/Main.jsp?Sid=<%=Sid%>&p3=1';**/
	window.parent.frames.mFrame.location = "Fix_To_Trace.do?Cmd=0&Sid=<%=Sid%>&Cpm_Id=0100000001&Func_Corp_Id=9999&Func_Sub_Id=0";
}
