...
<%
  ...
  ArrayList Spa_Station_L_Log = (ArrayList)session.getAttribute("Spa_Station_L_Log_" + Sid);
  int sn  = 0;
  
%>
<body style="background:#CADFFF">
<form name="Spa_Station_L_Log"  action="Spa_Station_L.do" method="post" target="_self">
		...
		<tr height='25px'>
			<td width='100%' align='center'>
				<table width="100%" border=1 cellPadding=0 cellSpacing=0 bordercolor="#3491D6" borderColorDark="#ffffff">
					...
					<%
					if(Spa_Station_L_Log != null)
					{
						Iterator iterator = Spa_Station_L_Log.iterator();
						while(iterator.hasNext())
						{
							SpaStationLBean Bean = (SpaStationLBean)iterator.next();
					...
					%>
						<tr height='30'>
							<td width='100%' align=center colspan=8>无!</td>
						</tr>
					<%
					}
					%>
...
function doSelect()
{
	//Spa_Station_L_Log.Cpm_Id.value = Spa_Station_L_Log.Func_Cpm_Id.value;
	Spa_Station_L_Log.submit();
}
</script>
</html>