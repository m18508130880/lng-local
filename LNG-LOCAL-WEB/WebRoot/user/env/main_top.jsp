			...
			<div id="banner_r">
				<ul>
					<li style="display:<Limit:limitValidate userrole='<%=FpList%>' fpid='0401' ctype='1'/>">
						<img onClick="doEnv()" style="cursor:hand" src="../../skin/images/top_menu_env_realtime.gif" alt="实时数据"/>
					</li>	
					<li style="display:<Limit:limitValidate userrole='<%=FpList%>' fpid='0402' ctype='1'/>">
						<img onClick="doHis()" style="cursor:hand" src="../../skin/images/top_menu_env_his.gif"      alt="历史数据"/>
					</li>
					<li style="display:<Limit:limitValidate userrole='<%=FpList%>' fpid='0403' ctype='1'/>">
						<img onClick="doGra()" style="cursor:hand" src="../../skin/images/top_menu_env_graph.gif" 	 alt="数据图表"/>
					</li>
				</ul>
			</div>
		</div>
