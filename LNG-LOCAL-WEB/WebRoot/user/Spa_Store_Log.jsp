...
<%
  ...
  ArrayList Spa_Store_Log  = (ArrayList)session.getAttribute("Spa_Store_Log_" + Sid);
  int sn  = 0;
  
%>
<body style="background:#CADFFF">
<form name="Spa_Store_Log"  action="Spa_Store.do" method="post" target="_self">
		...
		<tr height='25px'>
			<td width='100%' align='center'>
				<table width="100%" border=1 cellPadding=0 cellSpacing=0 bordercolor="#3491D6" borderColorDark="#ffffff">
					...
					<%
					if(Spa_Store_Log != null)
					{
						Iterator iterator = Spa_Store_Log.iterator();
...
function doSelect()
{
	//Spa_Store_Log.Cpm_Id.value = parent.window.parent.frames.lFrame.document.getElementById('id').value;
	Spa_Store_Log.submit();
}
</script>
</html>