			...
			<td width='100%' align='center' colspan=2>
				<table width="100%" border=1 cellPadding=0 cellSpacing=0 bordercolor="#3491D6" borderColorDark="#ffffff">
					<tr height='25' valign='middle'>
						<td width='10%' align='center' class="table_deep_blue">演练单位</td>
						<td width='10%' align='center' class="table_deep_blue">演练类型</td>
						<td width='10%' align='center' class="table_deep_blue">演练次数</td>
						<td width='10%' align='center' class="table_deep_blue">参演人数</td>
					</tr>
					<%
					if(Sat_Drill_L != null)
					{
