		...
		<tr height='25px' class='sjtop'>
			<td width='80%' align='left'>
				...
				<select  name='Func_Cpm_Id' style='width:100px;height:20px' onChange="doSelect()" >		
					<option value='' <%=currStatus.getFunc_Cpm_Id().equals("")?"selected":""%>>全部</option>		
						<%														
			...
			<td width='100%' align='center' colspan='2'>
				<table width="100%" border=1 cellPadding=0 cellSpacing=0 bordercolor="#3491D6" borderColorDark="#ffffff">
					<tr height='25' valign='middle'>
						...
						<td width='5%' align='center' class="table_deep_blue">单位</td>
						<td width='5%' align='center' class="table_deep_blue">出库数量</td>
						<td width='5%' align='center' class="table_deep_blue">单价</td>
						<td width='5%' align='center' class="table_deep_blue">金额</td>					
						<td width='10%' align='center' class="table_deep_blue">出库时间</td>
						<td width='10%' align='center' class="table_deep_blue">领料单位</td>
						<td width='8%' align='center' class="table_deep_blue">领料人员</td>
						<td width='7%' align='center' class="table_deep_blue">经手人员</td>
