								...
								<td width='100%' align=center colspan=7>
									<table width="100%" border=0 cellPadding=0 cellSpacing=0 bordercolor="#3491D6" borderColorDark="#ffffff">
										<tr height='30'>
											...
											<td width='65%' align=left><strong>站点名称: <%=T_Cpm_Name%></strong></td>
						  	...
						  	switch(Integer.parseInt(currStatus.getFunc_Corp_Id()))
								{
									...
									case 2900://其他柴油
								%>
											<td width='14%' align=center>燃油类(L)</td>
									    <td width='14%' align=center>折合质量(kg)</td>
									    <td width='14%' align=center>燃油类(L)</td>
									    <td width='14%' align=center>折合质量(kg)</td>
									    <td width='14%' align=center>燃油类(L)</td>
									    <td width='14%' align=center>折合质量(kg)</td>
								<%	
									...
									case 3002://LNG
								%>
											<td width='14%' align=center>燃气类(kg)</td>
									    <td width='14%' align=center>折合气态(m3)</td>
									    <td width='14%' align=center>燃气类(kg)</td>
									    <td width='14%' align=center>折合气态(m3)</td>
									    <td width='14%' align=center>燃气类(kg)</td>
									    <td width='14%' align=center>折合气态(m3)</td>
	...
	switch(parseInt(pFunc_Sub_Id))
	{
		case 1://上月
			  ...
			  var Month = BTime.substring(5,7);
				window.parent.frames.mFrame.location = "Pro_L.do?Cmd=0&Sid=<%=Sid%>&Cpm_Id="+window.parent.frames.lFrame.document.getElementById('id').value+"&Func_Sub_Id="+pFunc_Sub_Id+"&Func_Corp_Id="+Pro_L.Func_Corp_Id.value+"&BTime="+BTime+"&ETime="+ETime+"&Year="+Year+"&Month="+Month;
			break;
		case 2://本周
				...
				var BTime = TDay;
				var ETime = TDay;
				window.parent.frames.mFrame.location = "Pro_L.do?Cmd=3&Sid=<%=Sid%>&Cpm_Id="+window.parent.frames.lFrame.document.getElementById('id').value+"&Func_Sub_Id="+pFunc_Sub_Id+"&Func_Corp_Id="+Pro_L.Func_Corp_Id.value+"&BTime="+BTime+"&ETime="+ETime+"&Year="+Year+"&Month="+Month+"&Week="+Week;
			break;
		case 3://昨天
				var BTime = showPreviousDay().format("yyyy-MM-dd");
				window.parent.frames.mFrame.location = "Pro_L.do?Cmd=4&Sid=<%=Sid%>&Cpm_Id="+window.parent.frames.lFrame.document.getElementById('id').value+"&Func_Sub_Id="+pFunc_Sub_Id+"&Func_Corp_Id="+Pro_L.Func_Corp_Id.value+"&BTime="+BTime;
			break;
	}
}
...
function doSelect()
{
	Pro_L.Cpm_Id.value = window.parent.frames.lFrame.document.getElementById('id').value;
...
function doExport()
{
	...
	if(confirm("确定导出?"))
  {
		if(window.XMLHttpRequest)
	  {
		...
		var url = "Pro_L_Export.do?Sid=<%=Sid%>&Operator_Name=<%=Operator_Name%>&Cpm_Id="+window.parent.frames.lFrame.document.getElementById('id').value+"&BTime="+BTime+"&ETime="+ETime+"&Func_Sub_Id="+Pro_L.Func_Sub_Id.value+"&Func_Corp_Id="+Pro_L.Func_Corp_Id.value+"&Year="+Pro_L.Year.value+"&Month="+Pro_L.Month.value;
