				...
				<td width='100%' align='center'>
					<table width="100%" border=1 cellPadding=0 cellSpacing=0 bordercolor="#3491D6" borderColorDark="#ffffff">		
						...
						<tr height='30'>
							...
							<td width='75%' align='left'>
								<input type='text' name='Price' style='width:280px;height:18px;' value='' maxlength='10'> 元/L 或 元/kg
							</td>
						</tr>
						<tr height='30'>
							<td width='25%' align='center'>加注金额</td>
							<td width='75%' align='left'>
								<input type='text' name='Amt' style='width:280px;height:18px;' value='' maxlength='10'> 元
							</td>
						</tr>
						<tr height='30'>
						...
						<tr height='30'>
							<td width='25%' align='center'>编码字串</td>
