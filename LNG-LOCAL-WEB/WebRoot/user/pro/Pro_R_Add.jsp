...
<div id="down_bg_2">
	<div id="cap"><img src="../skin/images/pro_r_add.gif"></div><br><br><br>
				...
				<td width='100%' align='center'>
					<table width="100%" border=1 cellPadding=0 cellSpacing=0 bordercolor="#3491D6" borderColorDark="#ffffff">		
						...
						<tr height='30'>
							...
							<td width='75%' align='left'>
								<select id="Tank_No" name="Tank_No" style="width:282px;height:20px" onchange="doTank(this.value)">
									<option value='1'>1号罐 </option>
									<option value='2'>2号罐 </option>
									<option value='3'>3号罐 </option>
									<option value='4'>4号罐 </option>
								</select>
							</td>
						</tr>
						...
						<tr height='30'>
							...
							<td width='75%' align='left'>
								<input type='text' name='Value' style='width:280px;height:18px;' value='0.00' maxlength='10'> L 或 kg
							</td>
						</tr>
					<!--20150314修改-->	
						<tr height='30'>
							...
							<td width='75%' align='left'>
								<input type='text' name='Value_Plan' style='width:280px;height:18px;' value='0.00' maxlength='10'> L 或 kg
							</td>
						</tr>
						
						<tr height='30'>
							<td width='25%' align='center'>卸车时间</td>
							<td width='75%' align='left'>
						...
						<tr height='30'>
							...
							<td width='75%' align='left'>
								<input type='text' name='Value_Ware' style='width:280px;height:18px;' value='' maxlength='10'> L 或 kg
							</td>
						</tr>
						<tr height='30'>
...
/**不重复添加罐号
function doTank(Num){
	var length = document.getElementById('Tank_No').length;
	for( var i =0; i<length;i++){
