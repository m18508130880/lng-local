			...
			<tr height='30'>
				<td width='100%' align='center'>
					<table width="100%" border=1 cellPadding=0 cellSpacing=0 bordercolor="#3491D6" borderColorDark="#ffffff">		
						<tr height='30'>
							<td width='25%' align='center'>卸车站点</td>
						...
						<tr height='30'>
							<td width='25%' align='center'>磅单编号</td>
							<td width='75%' align='left'>
								<input type='text' name='Order_Id' style='width:280px;height:18px;' value='' maxlength='20'>
							</td>
						</tr>
						<tr height='30'>
							<td width='25%' align='center'>磅单数量</td>
							<td width='75%' align='left'>			
								<input type='text' name='Order_Value' style='width:280px;height:18px;' value='' maxlength='10'> L 或 kg
							</td>
						</tr>
						<tr height='30'>
						...
						<tr height='30'>
							<td width='25%' align='center'>卸车数量</td>
							<td width='75%' align='left'>
								<input type='text' name='Value' style='width:280px;height:18px;' value='' maxlength='10'> L 或 kg
							</td>
						</tr>
						<tr height='30'>
							<td width='25%' align='center'>运输车牌</td>
							<td width='75%' align='left'>							
