...
<%
	...
	ArrayList Aqsc_Drill_Type = (ArrayList)session.getAttribute("Aqsc_Drill_Type_" + Sid);
	
 	String Id = request.getParameter("Id");
  String CName = "";
	String Status = "0";
	String Des = "";
	if(Aqsc_Drill_Type != null)
	{
		Iterator iterator = Aqsc_Drill_Type.iterator();
		while(iterator.hasNext())
		{
			AqscDrillTypeBean statBean = (AqscDrillTypeBean)iterator.next();
...
<form name="Aqsc_Drill_Type_Edit" action="Aqsc_Drill_Type.do" method="post" target="mFrame">
<div id="down_bg_2">
	<div id="cap"><img src="../skin/images/aqsc_drill_type.gif"></div><br><br><br>
...
function doNO()
{
	location = "Aqsc_Drill_Type.jsp?Sid=<%=Sid%>";
}

function doEdit()
{
  if(Aqsc_Drill_Type_Edit.CName.value.Trim().length < 1)
  {
    alert("请输入名称!");
    return;
  }
  if(Aqsc_Drill_Type_Edit.Des.value.Trim().length > 128)
  {
    alert("描述过长，请简化!");
    return;
  }
