...
<form name="Aqsc_Train_Type" action="Aqsc_Train_Type.do" method="post" target="mFrame">
<div id="down_bg_2">
...
function doAdd()
{
	location = "Aqsc_Train_Type_Add.jsp?Sid=<%=Sid%>";
}

function doEdit(pId)
{
	location = "Aqsc_Train_Type_Edit.jsp?Sid=<%=Sid%>&Id="+pId;
}
</SCRIPT>
</html>