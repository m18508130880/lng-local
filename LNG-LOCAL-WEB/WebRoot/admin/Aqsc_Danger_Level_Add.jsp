...
<form name="Aqsc_Danger_Level_Add" action="Aqsc_Danger_Level.do" method="post" target="mFrame">
<div id="down_bg_2">
...
function doAdd()
{
  if(Aqsc_Danger_Level_Add.CName.value.Trim().length < 1)
  {
    alert("请输入名称!");
    return;
  }
  if(Aqsc_Danger_Level_Add.Des.value.Trim().length > 128)
  {
    alert("描述过长，请简化!");
    return;
  }
