...
<form name="Aqsc_Device_Breed_Edit" action="Aqsc_Device_Breed.do" method="post" target="mFrame">
<div id="down_bg_2">
...
function doNO()
{
	location = "Aqsc_Device_Breed.jsp?Sid=<%=Sid%>";
}

function doEdit()
{
  if(Aqsc_Device_Breed_Edit.CName.value.Trim().length < 1)
  {
    alert("请输入名称!");
    return;
  }
  if(Aqsc_Device_Breed_Edit.Des.value.Trim().length > 128)
  {
    alert("描述过长，请简化!");
    return;
  }
