...
<%
	...
	ArrayList Aqsc_Danger_Level = (ArrayList)session.getAttribute("Aqsc_Danger_Level_" + Sid);
	
 	String Id = request.getParameter("Id");
  String CName = "";
	String Status = "0";
	String Des = "";
	if(Aqsc_Danger_Level != null)
	{
		Iterator iterator = Aqsc_Danger_Level.iterator();
		while(iterator.hasNext())
		{
			AqscDangerLevelBean statBean = (AqscDangerLevelBean)iterator.next();
...
<form name="Aqsc_Danger_Level_Edit" action="Aqsc_Danger_Level.do" method="post" target="mFrame">
<div id="down_bg_2">
	<div id="cap"><img src="../skin/images/aqsc_danger_level.gif"></div><br><br><br>
...
function doNO()
{
	location = "Aqsc_Danger_Level.jsp?Sid=<%=Sid%>";
}

function doEdit()
{
  if(Aqsc_Danger_Level_Edit.CName.value.Trim().length < 1)
  {
    alert("请输入名称!");
    return;
  }
  if(Aqsc_Danger_Level_Edit.Des.value.Trim().length > 128)
  {
    alert("描述过长，请简化!");
    return;
  }
