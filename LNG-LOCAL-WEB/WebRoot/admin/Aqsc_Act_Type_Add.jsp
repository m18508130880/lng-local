...
<form name="Aqsc_Act_Type_Add" action="Aqsc_Act_Type.do" method="post" target="mFrame">
<div id="down_bg_2">
...
function doAdd()
{
  if(Aqsc_Act_Type_Add.CName.value.Trim().length < 1)
  {
    alert("请输入名称!");
    return;
  }
  if(Aqsc_Act_Type_Add.Des.value.Trim().length > 128)
  {
    alert("描述过长，请简化!");
    return;
  }
