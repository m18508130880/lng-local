...
<form name="Aqsc_Drill_Type" action="Aqsc_Drill_Type.do" method="post" target="mFrame">
<div id="down_bg_2">
...
function doAdd()
{
	location = "Aqsc_Drill_Type_Add.jsp?Sid=<%=Sid%>";
}

function doEdit(pId)
{
	location = "Aqsc_Drill_Type_Edit.jsp?Sid=<%=Sid%>&Id="+pId;
}
</SCRIPT>
</html>