...
<form name="Aqsc_Danger_Level" action="Aqsc_Danger_Level.do" method="post" target="mFrame">
<div id="down_bg_2">
...
function doAdd()
{
	location = "Aqsc_Danger_Level_Add.jsp?Sid=<%=Sid%>";
}

function doEdit(pId)
{
	location = "Aqsc_Danger_Level_Edit.jsp?Sid=<%=Sid%>&Id="+pId;
}
</SCRIPT>
</html>